...
public class FriendGroupController {
    ...
    @ResponseBody
    public ResultModel<Object> addFriendGroup(@RequestBody ReqFriendGroup reqFriendGroup,@RequestParam String appId,@RequestParam long userId){
    	logger.info("finUserInfo , parms:"+ JSON.toJSONString(reqFriendGroup));
    	return friendGroupService.addFriendGroup(reqFriendGroup,appId,userId);
    }
    ...
    @ResponseBody
    public ResultModel<Object> getFriendGroup(@RequestParam String appId,@RequestParam long userId){
    	logger.info("finUserInfo , parms:"+ JSON.toJSONString(appId));
    	return friendGroupService.getFriendGroup(appId,userId);
    }
