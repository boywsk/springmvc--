...
public class EditGroupMsg implements Serializable ,Runnable{
	/**
	 * 修改群信息
	 */
	...
	public void run() {
		try {
			...
			noticeMsg.setNoticeType(Constant.MSG_TASK_TYPE.UPDATE_GROUP_INFO.value);
			noticeMsg.setAppId(appId);
			noticeMsg.setCmd(Command.CMD_OPERATION);
			noticeMsg.setEditGroup(this);
