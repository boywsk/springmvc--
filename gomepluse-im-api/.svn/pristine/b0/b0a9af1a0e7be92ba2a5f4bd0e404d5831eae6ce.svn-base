...
<head>
	...
	<form action="/app-server/upload/uploadImage.json" method="post" enctype="multipart/form-data">
	...
	<form action="/app-server/upload/uploadVoice.json" method="post" enctype="multipart/form-data">
		<label for="file">file:</label>
	...
	<form action="/app-server/upload/uploadVideo.json" method="post" enctype="multipart/form-data">
		<label for="file">file:</label>
