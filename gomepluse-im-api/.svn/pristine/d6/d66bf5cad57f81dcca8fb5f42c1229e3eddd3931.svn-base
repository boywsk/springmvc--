...
public class NoticeApplicantMsg implements Serializable,Runnable {
	/**
	 * 通知被邀请加入群
	 */
   ...
   //TODO toUid 是否必要 liuzhenhuan 20160617
	...
	public void run() {
		try {
			...
			noticeMsg.setNoticeType(Constant.MSG_TASK_TYPE.INVITED_GROUP.value);
			noticeMsg.setAppId(appId);
			noticeMsg.setCmd(Command.CMD_OPERATION);
			noticeMsg.setNoticeApplicant(this);
