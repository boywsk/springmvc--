...
public class Constant {
	...
	public enum MSG_CONTENT_TYPE {
		AUDIT_GROUP(1),//加入群组审核
		UPDATE_GROUP(2),//更新群信息
		AUDIT_GROUP_RESULT(3),//加入群审核结果
		QUIT_GROUP(4),//退出群组
		KICK_GROUP(5),//群组踢人
		AUDIT_FRIEND(6),//好友申请审核
		AUDIT_FRIEND_RESULT(7),//好友申请审核结果
		REMOVE_FRIEND(8),//移除好友
		DISBAND_GROUP(9),//群组解散
		CREATE_GROUP(10);//创建群组
		public int value;
		MSG_CONTENT_TYPE(int value) {
			this.value = value;
		}
	}
}
