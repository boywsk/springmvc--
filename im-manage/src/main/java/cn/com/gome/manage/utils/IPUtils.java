...
public class IPUtils {
    ...
    public static long ipToLong(String strIp){
    	if(strIp.startsWith("http") || strIp.startsWith("https")) {
    		strIp = IPUtils.getUrlIP(strIp);
		}
        long[] ip = new long[4];
        //先找到IP地址字符串中.的位置
