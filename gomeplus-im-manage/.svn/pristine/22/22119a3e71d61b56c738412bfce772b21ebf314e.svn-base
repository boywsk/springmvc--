...
//	private int lastMsgType; // 最后一条消息类型
	private Object lastMsg; // 最后一条消息内容
//	private long msgSenderId;// 最后一条消息发送者id
//	private String msgSenderName;// 最后一条消息发送者昵称
//	private String msgSenderAvatar;// 最后一条消息发送者头像
//	private String msgUrl; // 最后一条消息链接
//	private long msgSendTime; // 最后一条消息发送时间
...
//	}
//
//	public String getMsgSenderAvatar() {
//		return msgSenderAvatar;
//	}
//
//	public void setMsgSenderAvatar(String msgSenderAvatar) {
//		this.msgSenderAvatar = msgSenderAvatar;
//	}
//
