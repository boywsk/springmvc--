...
public class Configuration {
	...
	private String fn = "/conf/config.properties";//配置文件名,有默认值
	...
	public Configuration(String fileName) throws ConfigurationException {
		try {
			...
			InputStream in = Thread.currentThread().getContextClassLoader().getResourceAsStream(fileName);// 属性文件输入流，默认service
