...
import cn.com.gome.api.service.UploadService;
import cn.com.gome.api.utils.ImageUtil;
import cn.com.gome.api.utils.QRCodeUtil;
import cn.com.gome.api.utils.TFSUploadFileUtil;
...
public class UploadServiceImpl implements UploadService {
	...
	@Override
	public ResultModel<Object> uploadImg(InputStream input, Constant.FILE_SUFFIX suffix, boolean originalImage) {
	...
	@Override
	public ResultModel<Object> uploadVoice(InputStream input,Constant.FILE_SUFFIX suffix) {
	...
	@Override
	public ResultModel<Object> uploadVideo(InputStream input, Constant.FILE_SUFFIX suffix) {
		int byteSize = 1024;//byte[]大小
		try{
			byteSize = input.available();
		}catch (Exception e){
	...
	public String uploadQRCodeImage(String content) {
		...
		try {
			...
			//将二维码上传   获取tfs文件名
			String suffix = "." + Constant.FILE_SUFFIX.JPG.value;//文件后缀
	 ...
	 * @return
	 */
	public ResultModel<Object> uploadFile(InputStream input, Constant.FILE_SUFFIX suffix, int byteSize){
